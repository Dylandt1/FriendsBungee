package fr.patapom.fbg.utils.exceptions;
...
public class FManagerNotFoundException extends Exception
{
    public FManagerNotFoundException(UUID uuid)
    {
        super("This manager doesn't find on §cRedisson §for §3MySQL §fserver §c!");
    }
}
