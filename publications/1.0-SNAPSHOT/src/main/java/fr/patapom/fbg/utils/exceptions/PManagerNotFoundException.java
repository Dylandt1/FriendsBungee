...
public class PManagerNotFoundException extends Exception
{
    public PManagerNotFoundException(UUID uuid)
    {
        super("This manager doesn't find on §cRedisson §fserver §c!");
    }
}
